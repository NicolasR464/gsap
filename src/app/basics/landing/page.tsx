...
export default function Tween() {
  useEffect(() => {
    ...
    tl.from(".demo", { ease: "linear", autoAlpha: 0 })
      ...
      .from("h2", { x: -80 }, "<")
      .from("p", { y: 30 }, "-=0.2")
      .fromTo("button", { y: 20 }, { y: 0, opacity: 1 }, "-=0.2")
      .from("#items > g", {
        scale: 0,
        stagger: 0.1,
  ...
  return (
    <div
      style={{
        backgroundImage:
          "url(https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fstatic.vecteezy.com%2Fsystem%2Fresources%2Fpreviews%2F000%2F607%2F377%2Foriginal%2Fvector-outdoor-park-playground-scene.jpg&f=1&nofb=1&ipt=06ad955e95d203b2e2304daea0fe89d529ba557c47fd422653b609f8b9e3d63c&ipo=images)",
        backgroundSize: "cover",
      }}
      className="h-screen demo invisible flex items-center"
    >
      <div className="txt flex flex-col items-center justify-center p-3 mt-80">
        <h1 className="text-4xl text-rose-100	text-center">creative</h1>
        <h2 className="text-3xl text-rose-100	text-center">pr🍩cess</h2>
        <p className="text-xl text-rose-100 text-center">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti sed
          corporis culpa vel impedit voluptate necessitatibus tenetur. Provident
          iure sapiente, possimus fuga quidem voluptas eveniet unde nobis minima
          aliquam magni.
        </p>
        <button className="btn btn-error w-20 button">read more</button>
      </div>

      <div className="images self-end mb-28">
        <svg>
          <defs></defs>
          <g id="items">
            <g id="earth">
